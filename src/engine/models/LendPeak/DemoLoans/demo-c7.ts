  ...
  static LendPeakObject(): LendPeak {
    ...
    const lendPeak = new LendPeak({
      ...
      depositRecords: new DepositRecords([
        ...
        new DepositRecord({
          amount: 956.01,
          effectiveDate: today.minus(3, ChronoUnit.MONTHS).withDayOfMonth(28),
          id: "DEPOSIT-C07-21",
          currency: "USD",
        }),
        new DepositRecord({
          amount: 956.01,
          effectiveDate: today.minus(2, ChronoUnit.MONTHS).withDayOfMonth(28),
          id: "DEPOSIT-C07-22",
          currency: "USD",
        }),
        new DepositRecord({
          amount: 956.01,
          effectiveDate: today.minus(1, ChronoUnit.MONTHS).withDayOfMonth(28),
          id: "DEPOSIT-C07-23",
          currency: "USD",
        }),
